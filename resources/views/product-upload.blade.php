...
<body class=" bg-gray-100 flex justify-center items-center min-h-screen">
    ...
    <section class="dark:bg-gray-900 rounded-lg w-full max-w-7xl m-auto p-4 sm:p-8">
        ...
        <div class="flex flex-col md:flex-row space-x-0 md:space-x-8">
            ...
            <div class="w-full md:w-1/2">
                <form action="{{ route('brands.store') }}" method="POST"
                    ...
                    @csrf
                    <div class="mb-6">
                        <label for="brand_name" class="block text-sm font-medium text-gray-900 dark:text-white">Brand
                            Name</label>
                        <input type="text" id="brand_name" name="brand_name" required
                            class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-lg dark:bg-gray-800 dark:text-white">
                    </div>
                    <button type="submit"
                        class="inline-block px-6 py-2.5 bg-gradient-to-br from-indigo-600 to-purple-500 text-white font-medium text-sm leading-tight uppercase rounded-lg shadow-md transition-all duration-300 hover:from-purple-500 hover:to-indigo-600 hover:shadow-lg">
                        Submit Brand
                    </button>
            ...
            <div class="w-full md:w-1/2">
                <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex items-center space-x-4 mt-6">
                        <button type="submit"
                            class="text-white bg-gradient-to-br from-indigo-600 to-purple-500 hover:from-indigo-700 hover:to-purple-600 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                            Upload Product
                        </button>
