        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <nav class="hidden md:flex space-x-6">
                    ...
                    <a href="{{ route('myreferrals') }}" class="text-gray-600 hover:text-blue-500">MY REFERRALS</a>
...
<div id="dropdown-menu" class="absolute right-0 mt-[150px] w-[150px] bg-white border border-gray-200 shadow-md rounded-md hidden">
    ...
    <a href="{{ route('profile.uploadForm') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">Edit Profile</a>
    ...
    <form method="POST" action="{{ route('logout') }}">
        ...
        <nav id="mobile-menu" class="md:hidden hidden bg-white ">
            ...
            <a href="{{ route('myreferrals') }}" class="block px-4 py-2 text-gray-600 hover:bg-gray-100">MY REFERRALS</a>
    ...
    <!-- Main Content -->
    <main class="pt-[100px] mx-auto max-w-7xl ">
