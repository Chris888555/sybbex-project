...
<main class="bg-white w-[95%] sm:w-[600px] md:w-[700px] lg:w-[500px] p-8 rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
        ...
        @if(session('success'))
    <div class="flex items-center bg-green-100 text-green-700 border border-green-400 p-2 sm:p-3 rounded-md mt-3 sm:mt-5 max-w-[100%] sm:max-w-lg mx-auto text-sm sm:text-base">
...
@endif
        ...
        <section class="mt-10">
            <form class="flex flex-col" method="POST" action="{{ route('register.post') }}">
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    ...
                    <input type="text" id="name" name="name" required class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-purple-600 transition duration-500 px-3 pb-3" value="{{ old('name') }}">
                </div>

                <div class="mb-6 pt-3 rounded bg-gray-200">
                    <label class="block text-gray-700 text-sm font-bold mb-2 ml-3" for="email">Email</label>
                    <input type="email" id="email" name="email" required class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-purple-600 transition duration-500 px-3 pb-3" value="{{ old('email') }}">
                </div>
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200 relative">
                    ...
                    <input type="password" id="password_confirmation" name="password_confirmation" required class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-purple-600 transition duration-500 px-3 pb-3 pr-10">
        ...
        <div class="text-center mt-6">
            <p class="text-gray-800">Already have an account? <a href="{{ route('login') }}" class="font-bold hover:underline">Sign in</a>.</p>
        </div>
    </main>
