...
<body>
    ...
    <header
        ...
        <div class="container mx-auto flex justify-between items-center px-4 sm:px-6">
            <!-- Shop Title -->
            <h1 class="text-2xl font-bold text-violet-500 hover:text-indigo-800 transition duration-300">Shop</h1>
   ...
   drop-shadow-lg tracking-wide uppercase relative inline-block">{{ $brand->brand_name }}</h1>
                ...
                <div class="container flex flex-col md:flex-row w-full">
                    ...
                    <div class="w-full md:w-1/3 mb-4 md:mb-0">
                        <img src="{{ asset('storage/' . $product->image_path) }}"
                            class="w-full h-auto md:h-auto md:w-[350px] object-contain rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)]" alt="{{ $product->name }}">
                    </div>
        ...
        <div id="cart-sidebar"
            ...
            <div class="p-4 relative">
                ...
                <p class="mt-6 font-bold text-lg">Grand Total: <span id="cart-total"
                        class="text-blue-600">&#8369;0.00</span></p>

                <!-- Checkout Button -->
                <button class="w-full bg-blue-600 text-white py-2 rounded-lg mt-4"
